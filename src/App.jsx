...
import { ABOUTE_ROUTE, ALL_SERVICES_ROUTE, BLOG_ROUTE, CONTACTS_ROUTE, PRICES_ROUTE } from "./utils/routes";
              ...
              BeforeAfterPagesArr.map((page, idx) => {
                return (
                  <Route
                    ...
                    path={page.path}
                    element={
                      <BeforeAfterPage coverDescription={page.coverDescription} beforeAfterPhotosArr={page.beforeAfterPhotosArr}
                      metaTitle={page.metaTitle}
                      metaDescription={page.metaDescription}
                      metaUrl={page.metaUrl}
            ...
            }
            {
              seoPagesArr.map((page, idx) => {
                return (
                  ...
                  path={page.path}
                  element={
                    <SeoBlogPage coverDescription={page.coverDescription} 
                    metaTitle={page.metaTitle}

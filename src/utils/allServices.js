    ...
    subcategorys: [
      {
        services: [
          ...
          {
            title: "УЗД передміхурової залози (трансабдомінально)",
            price: "400 грн",
          },
          {
            title: "УЗД нирок, сечового міхура та передміхурової залози",
    ...
    subcategorys: [
      {
        services: [
          ...
          {
            title: "Повторна консультація кардіолога (протягом 1 місяця)",
            price: "500 грн",
          },
          {
          ...
          {
            title: "Консультація кардіолога + УЗД серця + ЕКГ",
            price: "1300 грн",
          },
        ],
      },

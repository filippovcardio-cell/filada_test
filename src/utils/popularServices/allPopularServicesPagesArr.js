...
export const popularServicesArr = [
  {
    ...
    h1: "SMAS-ліфтинг",
    text: [
      "SMAS-ліфтинг — метод підтяжки, що працює з глибшими структурами, ніж звичайні поверхневі процедури.",
      "На консультації лікар оцінює показання, стан тканин та підбирає оптимальну тактику.",
